...
«Аким на 5 часов» позволяет проверить такие решения в учебной модели Астаны. Проект рассчитан на участников хакатона, студентов и команды, изучающие городское управление. Пользователь получает **100 условных бюджетных единиц**, выбирает **ровно пять мер** и видит результат для города и каждого района.
